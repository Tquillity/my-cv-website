...
export const VectorRacer = ({ onExit }: { onExit: () => void }) => {
  ...
  return (
    <div className="absolute inset-0 z-50 bg-black flex flex-col items-center justify-center font-mono">
      <div className="absolute top-4 left-4 text-green-500 text-xl font-bold">{t('racer_score')} {score}</div>
      <div className="absolute top-4 right-4 text-green-700 text-sm">{t('racer_controls')}</div>
